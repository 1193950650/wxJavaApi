...
@SpringBootTest(classes=BsApplication.class)// 指定spring-boot的启动类
...
//         gc.setControllerName("%sAction");
        ...
        dsc.setPassword("mhs123456%");
        dsc.setUrl("jdbc:mysql://132.232.87.134:3306/wx?characterEncoding=utf8&useSSL=false");
        ...
        strategy.setInclude(new String[] {}); // 需要生成的表	"bs_sla",,"user_match","user_role","user_security","function_right","bs_good_gradient","bs_good_grant"
