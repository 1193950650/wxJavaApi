 ...
 */
@ApiModel("内容-轮播配置")
@TableName("wx_cotent_broadcast_config")
public class Cotent_broadcast_config extends Model<Cotent_broadcast_config> {
    ...
    public String toString() {
        return "Cotent_broadcast_config{" +
        ", id=" + id +
